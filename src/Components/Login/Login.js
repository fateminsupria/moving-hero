        ...
        <div style={{ textAlign: 'center' }} className="button-style">
            {
                loggedInUser.email ?
                    ...
                    <Button onClick={handleGoogleSignIn} variant="contained" color="secondary">Log In With Google</Button>
            }
           &nbsp; &nbsp;
            {
                loggedInUser.email ?
                    <Button onClick={handleSignOut} variant="contained" color="secondary">Log Out</Button> :
                    <Button onClick={handleFacebookLogIn} variant="contained" color="secondary">Log In With Facebook</Button>
            }
